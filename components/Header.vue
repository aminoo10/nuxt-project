<template>
  <b-navbar toggleable="lg" type="dark" variant="info">
    ...
    <!--tenative name until I come up with something cooler -->
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav v-show="show" class="ml-auto">
        <b-nav-form>
          <!-- I couldn't get the search input in the header to tie in well with the search from here, so I'm going to omit it until I can figure out a good way of implementing it -->
          <b-form-input
            v-on:keydown.enter="submit"
            v-model="query"
            size="sm"
            class="mr-sm-2 searchbar"
            placeholder="Search"> 
            </b-form-input>
          ...
          <b-button
            ...
            class="my-2 my-sm-0"
            type="submit"
            title="Your search must have at least three (3) characters">
            Search</b-button>
        </b-nav-form>
        <b-form-checkbox
          v-model="checked"
